...
class Calc_MMPBSA:
    def __init__(self, MMPBSA_dir, system_prmtop, traj_dcd, percentage: float):
...
class Wrapper_MMPBSA:
    ...
    posix_dict : Dict
        ...
        {
            'C4_fake': {
                'PRMTOP': '/home/hitesit/Python_Packages/OpenMM_VanillaMD_MMPBSA/examples/C4_fake/system.prmtop',
                'DCD': '/home/hitesit/Python_Packages/OpenMM_VanillaMD_MMPBSA/examples/C4_fake/Step3_Md_Rep0.dcd'
            },
            'C4_prep': {
                'PRMTOP': '/home/hitesit/Python_Packages/OpenMM_VanillaMD_MMPBSA/examples/C4_prep/system.prmtop',
                'DCD': '/home/hitesit/Python_Packages/OpenMM_VanillaMD_MMPBSA/examples/C4_prep/Step3_Md_Rep0.dcd'
            }
        }
